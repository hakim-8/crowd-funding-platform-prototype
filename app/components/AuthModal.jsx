...
export default function AuthModal({ isOpen, onClose, initialMode = "login", userType = "investor" }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#064e3b]/40 backdrop-blur-sm p-4">
      ...
      >
        <div className="relative h-24 bg-[#064e3b] flex items-center justify-center">
          ...
          <h2 className="text-2xl font-bold text-[#fdfbf7] capitalize tracking-wide">
        ...
        <div className="p-8">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button 
              type="button"
              onClick={onClose}
              className="w-full bg-[#059669] hover:bg-[#10b981] text-[#fdfbf7] font-semibold py-3 px-4 rounded-lg transition-colors shadow-lg shadow-[#059669]/20 mt-4"
            >
