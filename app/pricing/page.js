    ...
    <div className="flex flex-col min-h-screen bg-[#fdfbf7] pb-24">
      ...
      <section className="pt-32 pb-16 px-4 text-center relative overflow-hidden">
        ...
        <p className="text-xl text-[#064e3b]/80 max-w-2xl mx-auto leading-relaxed">
          We only succeed when you succeed. No hidden fees, no complicated
          tiers.
        </p>
      </section>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-[#059669]/5 border border-[#f2eadb] relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[#064e3b]/70 mb-8">
                Launch your project with zero upfront costs.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#064e3b]/70">
                      Applied only to successfully funded projects.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#064e3b]/70">
                      Standard credit card processing fees ($0.30 per
                      transaction).
                    </p>
                  </div>
                </div>
            ...
            <div className="border-t md:border-t-0 md:border-l border-gray-100 pt-8 md:pt-0 md:pl-12">
              ...
              <p className="text-[#064e3b]/70 mb-8">
                Invest without worrying about overhead.
              </p>

              <div className="bg-[#ecfdf5] p-6 rounded-2xl border border-[#34d399]/30 mb-8">
                <div className="text-4xl font-extrabold text-[#059669] mb-2">
                  0%
                </div>
                <h3 className="font-bold text-[#064e3b] mb-1">Platform Fee</h3>
                <p className="text-sm text-[#064e3b]/70">
                  Backers never pay a fee to pledge on Jade Fortune.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
          ...
          <div className="bg-white p-6 xl:p-8 rounded-3xl border border-[#f2eadb] shadow-sm flex flex-col">
            ...
            <p className="text-[#064e3b]/70 text-sm mb-6">
              Perfect for small projects and initial raises.
            </p>
            <div className="text-4xl font-extrabold text-[#064e3b] mb-6">
              5%{" "}
              <span className="text-lg font-normal text-[#064e3b]/50">fee</span>
            </div>
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-start gap-2 text-[#064e3b]/80 text-sm">
                <svg
                  className="w-5 h-5 text-[#059669] shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <Link
              href="/register"
              className="block w-full py-3 px-4 bg-white border-2 border-[#059669] text-[#059669] font-bold text-center rounded-full hover:bg-[#ecfdf5] transition-colors"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="bg-white p-6 xl:p-8 rounded-3xl border border-[#f2eadb] shadow-sm flex flex-col">
            ...
            <p className="text-[#064e3b]/70 text-sm mb-6">
              For growing creators building an audience.
            </p>
            <div className="text-4xl font-extrabold text-[#064e3b] mb-6">
              4.5%{" "}
              <span className="text-lg font-normal text-[#064e3b]/50">fee</span>
          ...
          <div className="bg-[#064e3b] p-6 xl:p-8 rounded-3xl border border-[#064e3b] shadow-xl shadow-[#064e3b]/20 flex flex-col transform md:-translate-y-4 relative">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -mt-4 bg-[#34d399] text-[#064e3b] text-xs font-bold px-4 py-1 rounded-full uppercase tracking-widest">
              Recommended
            </div>
            <h3 className="text-xl font-bold text-white mb-2">Gold</h3>
            <p className="text-white/70 text-sm mb-6">
              For serious creators wanting maximum trust.
            </p>
            ...
            <Link
              href="/register"
              className="block w-full py-3 px-4 bg-[#059669] text-white font-bold text-center rounded-full hover:bg-[#047857] transition-colors border-2 border-[#059669]"
            >
              Start Gold Project
            </Link>
          </div>
          ...
          <div className="bg-white p-6 xl:p-8 rounded-3xl border border-[#f2eadb] shadow-sm flex flex-col">
            ...
            <p className="text-[#064e3b]/70 text-sm mb-6">
              For large-scale equity raises and syndicates.
            </p>
            <div className="text-4xl font-extrabold text-[#064e3b] mb-6">
              Custom
            </div>
            ...
            <Link
              href="/contact"
              className="block w-full py-3 px-4 bg-white border-2 border-gray-200 text-gray-600 font-bold text-center rounded-full hover:bg-gray-50 transition-colors"
            >
              Contact Sales
            </Link>
          </div>
      ...
      <section className="mt-24 text-center px-4">
        ...
        <Link
          href="/how-it-works"
          className="inline-block px-8 py-4 bg-emerald-900 text-white rounded-full font-bold text-lg hover:brightness-110 shadow-lg hover:shadow-emerald-600/20 transition-all"
        >
          Start a Project
        </Link>
      </section>
